...
The input data is first annotated using LabelMe annotation tool, there are 2 annotations made on the training and testing images named 'Mask' and 'No Mask'. After annotating the images the json format is converted into desired COCO format required by detectron2.
